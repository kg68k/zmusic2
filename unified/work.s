...
rs_midi:	dc.b	MIDI_TYPE	*1)MIDIタイプ(0=CZ6BM1,-1=RS232C,+1POLYPHON	!!!1
...
SPC2:	dc.b	'  ',0
crlf:	dc.b	CRLF,0
	dc.b	TAB		*(ERROR CODE表示時に使用)	!!!順番と位置を
...
read_mes1:	dc.b	"Block ADPCM data '",COL2,0
read_mes2:	dc.b	"Start up file '",COL2,0
cannot_read:	dc.b	COL3,"' couldn't be found.",CRLF,0
default_adp:	dc.b	COL3,"' has been included.",CRLF,0
vb_end:
	.even
